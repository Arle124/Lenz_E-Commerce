            ...
            <div class="dropdown account-dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <div class="dropdown-footer">
                  <a href="login_register.php" class="btn btn-primary w-100 mb-2">Sign In</a>
                  <a href="login_register.php" class="btn btn-outline-primary w-100">Register</a>
                </div>
              </div>
            </div>
                      ...
                      <div class="category-layout">
                        ...
                        <div class="featured-section">
                          <div class="featured-image">
                            <img src="../../../sassets/img/product/product-f-1.webp" alt="Women's Heels Collection">
